...
#TODO GET Image of timestamp and continously grab it.
#TODO Install pytessoraact
#TODO Methods for image recognition

def find_title_card(start_x, start_y, end_x, end_y, duration, timestamp, start_time):
     
   
    pyautogui.moveTo(start_x, start_y)
    time.sleep(1)
    pyautogui.moveTo(end_x, start_y, duration)
