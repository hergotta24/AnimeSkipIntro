...
if __name__ == "__main__":
    ...
    template_image_path2 = "OutroTemplate/laptop_template.png"  #Path to the template image you want to find

    click_x, click_y = 67, 1373  # Coordinates of Crunchry Roll Next Btn on my Monitor
    x, y = 138, 2027  # Coordinates of Crunchry Roll Next Btn on my laptop
    x1, y1 = 297, 1417
    ...
    for x in range(8, 0, -1):
        print("Starting auomation in " + str(x) + " seconds")
        time.sleep(1)
    while True:
